  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold font-heading ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // EasyMaths-specific variants
        "cta-red": "cta-gradient text-easy-white hover:opacity-90 shadow-medium hover:shadow-large transform hover:-translate-y-0.5",
        "cta-green": "hero-gradient text-easy-white hover:opacity-90 shadow-medium hover:shadow-large transform hover:-translate-y-0.5",
        "outline-green": "border-2 border-easy-green text-easy-green bg-transparent hover:bg-easy-green hover:text-easy-white",
      },
      size: {
